...
import { createWholePlanetExperience } from "./whole-planet-experience.js?v=ending-timeline-1";
...
import { createOpeningLoadProgress } from "./opening-load-progress.js?v=opening-futura-loading-1";
...
const experience = settings.view === "flight"
  ? createWholePlanetExperience({
    ...
    getExperienceMode: experienceMode.getMode,
    quality: settings.quality,
